...
export class SomeComponent extends Component<any, ISomeComponentState> {
  ...
  private getFullName() {
    // const urlendPoint = new URL('https://github.com/brucevilo1013');
    ...
    const urlendPoint = `https://github.com/brucevilo1013?firstName=${params.firstName}&lastName=${params.lastName}`;
