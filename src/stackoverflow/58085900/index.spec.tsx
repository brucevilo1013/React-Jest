...
describe('SomeComponent', () => {
  ...
  describe('#getFullName', () => {
    ...
    it('should fetch data correctly', async () => {
      ...
      expect(fetch).toBeCalledWith(`https://github.com/brucevilo1013?firstName=du&lastName=lin`);
    });
    ...
    it('should alert when fetch data error', async () => {
      ...
      expect(fetch).toBeCalledWith(`https://github.com/brucevilo1013?firstName=lin&lastName=du`);
